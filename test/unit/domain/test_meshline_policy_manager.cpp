...
SCENARIO("GridAxis cast(MeshlinePolicy::Axis const a)", "[meshline_policy_manager]") {
	GIVEN("A MeshLinePolicy::Axis enum class") {
		WHEN("MeshlinePolicy::Axis::X") {
			GridAxis a = cast(MeshlinePolicy::Axis::X);
			THEN("Should return X") {
				REQUIRE(a == X);
			}
		}
		WHEN("a == MeshlinePolicy::Axis::Y") {
			GridAxis a = cast(MeshlinePolicy::Axis::Y);
...
bool const is_enabled)", "[meshline_policy_manager]") {
	GIVEN("A meshline policy manager") {
		...
		WHEN("We add a meshline policy with incoherent axis and normal parameters") {
			MeshlinePolicy* m = mpm.add_meshline_policy(&e, MeshlinePolicy::Axis::X, MeshlinePolicy::Policy::THIRDS, Normal::YMIN, 1);
			MeshlinePolicy* n = mpm.add_meshline_policy(&e, MeshlinePolicy::Axis::X, MeshlinePolicy::Policy::THIRDS, Normal::YMAX, 1);
			MeshlinePolicy* o = mpm.add_meshline_policy(&e, MeshlinePolicy::Axis::Y, MeshlinePolicy::Policy::THIRDS, Normal::XMIN, 1);
			MeshlinePolicy* p = mpm.add_meshline_policy(&e, MeshlinePolicy::Axis::Y, MeshlinePolicy::Policy::THIRDS, Normal::XMAX, 1);
		...
		WHEN("We add a meshline policy with incoherent axis and normal parameters") {
			MeshlinePolicy* m = mpm.add_meshline_policy(
				&e, MeshlinePolicy::Axis::X, MeshlinePolicy::Policy::THIRDS, Normal::NONE, 1);
			MeshlinePolicy* n = mpm.add_meshline_policy(
				&e, MeshlinePolicy::Axis::X, MeshlinePolicy::Policy::ONELINE, Normal::XMIN, 1);
			MeshlinePolicy* o = mpm.add_meshline_policy(
				&e, MeshlinePolicy::Axis::X, MeshlinePolicy::Policy::ONELINE, Normal::XMAX, 1);
			MeshlinePolicy* p = mpm.add_meshline_policy(
				&e, MeshlinePolicy::Axis::Y, MeshlinePolicy::Policy::ONELINE, Normal::YMIN, 1);
			MeshlinePolicy* q = mpm.add_meshline_policy(
				&e, MeshlinePolicy::Axis::Y, MeshlinePolicy::Policy::ONELINE, Normal::YMAX, 1);
			MeshlinePolicy* r = mpm.add_meshline_policy(
				&e, MeshlinePolicy::Axis::X, MeshlinePolicy::Policy::HALFS, Normal::XMIN, 1);
			MeshlinePolicy* s = mpm.add_meshline_policy(
				&e, MeshlinePolicy::Axis::X, MeshlinePolicy::Policy::HALFS, Normal::XMAX, 1);
			MeshlinePolicy* t = mpm.add_meshline_policy(
				&e, MeshlinePolicy::Axis::Y, MeshlinePolicy::Policy::HALFS, Normal::YMIN, 1);
			MeshlinePolicy* u = mpm.add_meshline_policy(
				&e, MeshlinePolicy::Axis::Y, MeshlinePolicy::Policy::HALFS, Normal::YMAX, 1);
			MeshlinePolicy* v = mpm.add_meshline_policy(
				&e, MeshlinePolicy::Axis::X, MeshlinePolicy::Policy::RANGE, Normal::XMIN, 1);
			MeshlinePolicy* w = mpm.add_meshline_policy(
				&e, MeshlinePolicy::Axis::X, MeshlinePolicy::Policy::RANGE, Normal::XMAX, 1);
			MeshlinePolicy* x = mpm.add_meshline_policy(
				&e, MeshlinePolicy::Axis::Y, MeshlinePolicy::Policy::RANGE, Normal::YMIN, 1);
			MeshlinePolicy* y = mpm.add_meshline_policy(
				&e, MeshlinePolicy::Axis::Y, MeshlinePolicy::Policy::RANGE, Normal::YMAX, 1);
			THEN("No meshline policy should be added nor returned") {
				REQUIRE(mpm.line_policies[X].size() == 0);
				REQUIRE(mpm.line_policies[Y].size() == 0);
				REQUIRE(m == nullptr);
